...
use App\Filament\Resources\StudentInterestedCourseResource\Pages;
use App\Filament\Resources\StudentInterestedCourseResource\RelationManagers;
...
class StudentInterestedCourseResource extends Resource
{
    ...
    protected static ?string $label = 'Interested Course';
    ...
    {
        return [
            'index' => Pages\ListStudentInterestedCourses::route('/'),
            //'create' => Pages\CreateStudentInterestedCourse::route('/create'),
            'edit' => \App\Filament\Resources\StudentResource\Pages\EditStudent::route('../students/{record}/edit?activeRelationManager=1'),
        ];
    }
