...
return new class extends Migration
{
    ...
    {
        Schema::create('student_visa_documents', function (Blueprint $table) {
            $table->id();
            $table->foreignId('student_id')->constrained()->on('students')->onDelete('cascade');
            $table->foreignId('student_visa_id')->constrained()->on('student_visas')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('studen_visa_documents');
    }
};
