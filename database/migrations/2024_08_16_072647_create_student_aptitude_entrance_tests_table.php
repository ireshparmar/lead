...
return new class extends Migration
{
    ...
    {
        Schema::create('student_aptitude_entrance_tests', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('verbal_reasoning')->nullable();
            $table->decimal('quantitative_reasoning')->nullable();
            $table->decimal('analytical_reasoning')->nullable();
    ...
    {
        Schema::dropIfExists('student_aptitude_entrance_tests');
    }
};
