...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('student_admissions', function (Blueprint $table) {
            $table->id();
            $table->foreignId('application_id')->constrained()->on('student_college_applications')->onDelete('cascade');
            ...
            $table->string('is_move_to_visa', 20)->nullable()->comment('Yes,No');
            $table->string('is_admission_done', 20)->nullable()->comment('Yes,No');
